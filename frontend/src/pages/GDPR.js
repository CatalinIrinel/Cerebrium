  ...
  return (
    <div className="containerD p-4">
      <div className="container">
        <h1>Privacy Policy for Cerebrium Neurofeedback</h1>

        <p>
          At Cerebrium Neurofeedback, accessible from https://cerebrium.ro, one
          of our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by Cerebrium Neurofeedback and how we use it.
        </p>
        <p>
          Contact forms, from https://cerebrium.ro/contact, are use ONLY to get
          in touch with one of our offices and our offices to get in touch with
          you, the NAME, EMAIL and NUMBER, are not stored in any database of any
          kind, we DO NOT sell data to third party entities
        </p>
        ...
        <p>
          Cerebrium legal basis for collecting and using the personal
        ...
        <ul>
          <li>Cerebrium needs to perform a contract with you</li>
          <li>You have given Cerebrium permission to do so</li>
          <li>
            Processing your personal information is in Cerebrium legitimate
            interests
          </li>
          <li>Cerebrium needs to comply with the law</li>
        </ul>

        <p>
          Cerebrium will retain your personal information only for as long as is
        ...
        <p>
          Cerebrium Neurofeedback follows a standard procedure of using log
        ...
        <p>
          Like any other website, Cerebrium Neurofeedback uses 'cookies'. These
        ...
        <p>
          ...
          advertising partners of Cerebrium Neurofeedback.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Cerebrium Neurofeedback, which
        ...
        <p>
          Note that Cerebrium Neurofeedback has no access to or control over
        ...
        <p>
          Cerebrium Neurofeedback's Privacy Policy does not apply to other
        ...
        <p>
          Cerebrium Neurofeedback does not knowingly collect any Personal
        ...
        <p>
          ...
          shared and/or collect in Cerebrium Neurofeedback. This policy is not
